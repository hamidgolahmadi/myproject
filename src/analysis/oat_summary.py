"""Summarize legacy OAT simulation results."""
...
def summarize_oat_results(
    infile="oat_merged/oat_all_merged.csv",
    outdir="oat_summary",
):
    """Build topology-specific and pooled OAT summaries."""
    ...
    summary = (
        df.groupby(
            ["varied_parameter", "topology", "varied_value"],
            as_index=False,
        )
        .agg(
            n_runs=("seed", "count"),
